...
% Point 1
e1=E.position_joint_current;
ejoint(:,:,1)=e1;   % generation of the matrix of joint value 

c1e=E.position_current(1:3,4);
cce(:,:,1)=c1e;      % generation of the matrix of the cartesian values.
